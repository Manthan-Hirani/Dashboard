...
var HrDashboard = AbstractAction.extend({
    ...
    events: {
        ...
        'click .hr_employee_avg_salary': 'employee_avg_salary',
        'click .hr_employee_payroll': 'employee_payroll',
        'click .hr_all_employee_details_for_hr': 'all_employee_details_for_hr',
    ...
    leave_allocations_to_approve: function (e) {
        ...
        this.do_action({
            name: _t("Employee Leave Allocation"),
            type: 'ir.actions.act_window',
            res_model: 'hr.leave.allocation',
            view_mode: 'tree,form,calender',
            views: [[false, 'calender'], [false, 'form']],
            domain: [['state', 'in', ['confirm', 'validate1']]],
            target: 'current'
        }, options)
    },

    employee_avg_salary: function (e) {
        var self = this;
        e.stopPropagation();
        e.preventDefault();
        var options = {
    ...
    all_employee_details_for_hr: function (event) {
        var self = this;
    ...
    employee_payroll: function (event) {
        var self = this;
        event.stopPropagation();
        event.preventDefault();
        var options = {
    ...
    render_exp_salary_groups: function () {
        var self = this;
        var w = 200;
        var h = 200;
        var r = h / 2;
            ...
            function pieChart(pD) {
                ...
                function mouseover(d, i) {
                    ...
                    hG.update(fData.map(function (v) {
                        return [v.l_month, v.leave[d.data.type]];
                    }), color(i));
                }
